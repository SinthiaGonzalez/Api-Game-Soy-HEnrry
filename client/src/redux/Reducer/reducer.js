import { GET_ALL_GAMES,GET_GAME_BY_ID,FORM_DATA,POST_FORM_DATA_ERROR,POST_FORM_DATA,DELETE_GENRES,VALIDATION_PASS,GET_GAME_BY_NAME,FILTER_GAMES_BY_GENRE,FILTER_BY_ORDER,FILTER_BY_ORIGIN,FILTER_BY_RATING} from "../action/action"; // importamos la types de la accion que creamos
    ...
    switch (action.type) {
        ...
        case POST_FORM_DATA:
            return {
                ...
                releasedate: "",
                image: "",
                genreName: []},// limpiamos el estado global
